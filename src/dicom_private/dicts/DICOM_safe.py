...
Data generated 2025-01-31 22:35 from
...
safe_private_dict: dict[str, dict[str, tuple[str, str, str, str]]] = {
    ...
    'SIEMENS Ultrasound SC2000': {
        ...
        '0119xx11': ('None', '1', 'Stage Timer Time', ''),
        '0119xx12': ('None', '1', 'Stop Watch Time', ''),
        '0119xx13': ('IS', '1', 'Volume Rate', ''),
        '0119xx21': ('SH', '1', '', ''),
        '0129xx00': ('SQ', '1', 'MPR View Sequence', ''),
        '0129xx02': ('UI', '1', 'Bookmark UID', ''),
        '0129xx03': ('None', '1', 'Plane Origin Vector', ''),
        '0129xx04': ('None', '1', 'Row Vector', ''),
        '0129xx05': ('None', '1', 'Column Vector', ''),
